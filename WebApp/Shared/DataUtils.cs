public static class DataUtils
{
    ...
    public static string DEFAULT_NAME_MyParentData = "Default MyParentData Name";
    public static string DEFAULT_DESCR_MyParentData = "Default MyParentData Description";
    ...
    // units and labels
    public static readonly string MyParentDataMyBaseDataListLabel = "MyBaseDataList";
    public static readonly string MyParentDataOutputParamLabel = "MyParentDataOutputParam";
    public static readonly string MyParentDataNameLabel = "MyParentData name";
    public static readonly string MyParentDataDescrLabel = "MyParentData description";
    public static readonly string MyParentDataOutputParamQty = "DepthDrilling";
