...
class Program
{
    ...
    private static readonly string JSON_BUNDLE = "WellBoreSelectorMergedModel.json";
    private static readonly string CSHARP_MODEL = "WellBoreSelectorMergedModel.cs";
    private static readonly string PSEUDO_CTOR = "PseudoConstructors.cs";

    // ### BEGIN CODE SPECIFIC TO ModelSharedOut 3/3 ###
    private static readonly string NAMESPACE = "DWIS.ContextualData.WellBoreSelector.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
    ...
    static bool CreatePseudoConstructors(DirectoryInfo directory)
    {
        ...
        string nspace = "DWIS.ContextualData.WellBoreSelector.ModelShared";
